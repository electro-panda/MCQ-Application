...
export default function Navbar({ navigation }) {
    ...
    const handleClick = () => {
        ...
        axios.get(`${path}/logout`, {
            ...
            if (res.data.success) {
                navigate("/", { state: { success: res.data.success, message: res.data.message } })
            }
        })
    ...
    return (
        <Disclosure as="nav" className="bg-gray-800">
            <div className="mx-auto max-    w-8xl px-2 sm:px-3 lg:px-8">
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex shrink-0 items-center bg-white rounded-4xl p-2">
                            <img
                                alt="SmartAccess"
                                src={logo}
