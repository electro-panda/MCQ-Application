    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center mt-20 px-4 sm:px-8">
                ...
                <h2 className="text-2xl font-semibold text-center mb-6">Teacher Dashboard</h2>
                <div className="w-full max-w-4xl flex flex-col sm:flex-row justify-center sm:justify-between gap-6 mt-10">
                    <InteractiveBox color="red" text="View Tests" path="/view_tests" />
                    <InteractiveBox color="yellow" text="Create Test" path="/teacher/create_test" />
                    <InteractiveBox color="green" text="View Results" path="/view_results" />
                </div>
